export default function Heading(pageTitle = '', desc = '', image = '', url = '') {
	...
	const statics = [
		...
		<meta name="keywords" content="diseño grafico, diseño, design, editorial, social network, typography, ux, ui, website design, assets, resources, free" />,
	]
	...
	let title = 'Diseñamela - Facilitando la vida de los diseñadores';
	// if (pageTitle) {
	...
	return (
		<>
			...
			<meta name="og:url" content={"https://diseñamela.com" + url} />
